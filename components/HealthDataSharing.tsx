    ...
    <div className="bg-white border border-gray-200 p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-lg font-semibold text-gray-900 flex items-center">
            <Share2 className="mr-2 text-gray-700" size={20} />
            Health Data Sharing
          </h3>
        ...
        <button
          ...
          className="px-4 py-2 bg-blue-600 text-white border border-blue-700 hover:bg-blue-700 transition-colors text-sm font-medium"
        >
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="bg-white border border-gray-200 p-4">
          <div className="text-2xl font-bold text-gray-900">{sharedWith.length}</div>
        ...
        {sharedWith.map((share) => (
          ...
          >
            <div className="flex items-center flex-1">
              <div className="w-10 h-10 bg-gray-100 border border-gray-300 flex items-center justify-center mr-3">
              ...
              <div className="flex items-center mr-4">
                {share.access === 'full' ? (
                  <Eye className="text-gray-700 mr-2" size={18} />
                ) : (
