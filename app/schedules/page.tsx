    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {loading ? (
        ...
        <div className="bg-white border border-gray-200 p-8 text-center">
          <CalendarIcon className="mx-auto h-12 w-12 text-gray-400 mb-4" aria-hidden />
        ...
        <ul className="space-y-3">
          {schedules.map((s) => (
            <li key={s.id} className="bg-white border border-gray-200 p-4">
              <h2 className="text-lg font-semibold text-gray-900">{s.title}</h2>
              {s.description ? <p className="text-sm text-gray-700 mt-1">{s.description}</p> : null}
