...
export default function NewIncidentPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-lg">
      <h1 className="text-3xl font-bold text-garden-wood mb-6">Report incident</h1>
      <form onSubmit={onSubmit} className="space-y-4 bg-white border border-garden-sage-200/65 p-6">
        ...
        <div>
          <label htmlFor="severity" className="block text-sm font-medium text-garden-wood mb-1">
            Severity
          </label>
          <input
            id="severity"
        ...
        <div className="flex gap-2">
          ...
          <Link href="/safety" className="px-4 py-2 border border-garden-clay-200/85 text-garden-wood hover:bg-garden-sage-50/70">
            Cancel
          </Link>
        </div>
      </form>
