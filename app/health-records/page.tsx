    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {loading ? (
        ...
        <div className="bg-white border border-gray-200 p-8 text-center">
          ...
          <h2 className="text-lg font-medium text-gray-900 mb-2">No health records yet</h2>
        ...
        <ul className="space-y-3">
          {records.map((r) => (
            <li key={r.id} className="bg-white border border-gray-200 p-4">
              ...
              {r.content ? <p className="text-sm text-gray-800 mt-2 line-clamp-4">{r.content}</p> : null}
            </li>
          ))}
        </ul>
      )}
